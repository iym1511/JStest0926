...
public class Student implements Comparable{
	...
	public int compareTo(Object otherObject) {
		...
		// 비교하는 메소드 - Student객체를 받아와서 그 객체안의 grade를 비교하는 메소드
		
		// 1. otherObject를 instanceof 로 객체의 타입을 확인하고
		//   객체의 타입이 Student일때, 그 객체를 Student 객체로 형변환 한다
		...
		if(otherObject instanceof Student) {
			...
			// 2-1. 값이 같으면 0 을 return, 값이 this가 크면 1을 return
			//      this가 작으면 -1을 return
			...
			//		Student객체가 아닙니다 를 출력하고 return 10을 반환
