...
public class ExceptionTest {
	...
	public static void main(String[] args) {
		...
		int x=6;
		int y=0;
		int result = 0; // try구문안에 있는 변수는 값이 할당되지 않을수도 있기때문에
		//  미리 초기화
		...
		try {
			...
			System.out.println(e); // 오류발생 이유 알려줌
		}
		...
		int index = 10;
		try {
			System.out.println("결과"+arrayNum[index]);
		...
		}catch (Exception e) { // 정수가아닌 문자를입력하면 오류
		...
		// 예외 객체를 생성하는 클래스인 GreenException
		// Exception 상속하고
