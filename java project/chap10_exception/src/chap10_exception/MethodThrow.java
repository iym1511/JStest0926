...
public class MethodThrow {
	...
	public int numArray(int num) throws ArrayIndexOutOfBoundsException{
		return this.NUMBER[num];
	}
	
	// 사용자 정의 예외 객체 사용
	// 에러가 발생하기 때문에 메소드에 throws를 통해 알려준다
	public void myMethode() throws MyException{ // MyException /으로 던져쥼
		// 실행할때 마다 항상 MyExceotion 에러를 만드는 메소드
		if(true) {
