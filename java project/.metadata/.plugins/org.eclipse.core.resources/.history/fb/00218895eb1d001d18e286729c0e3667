...
public class PolymoTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(myCar.speedUp(10)); // SportsCar에꺼 출력
		...
		// 상속에서의 다형성
		// Car라는 부모클래스 안에 여러가지 자식클래스가 들어갈수 있다.
